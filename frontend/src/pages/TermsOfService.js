...
import "../styling/privacyNterms.css"
...
const TermsOfService = () => {
  ...
  <div data-custom-class="body">
            ...
            >
              ...
              >
                ...
                >
                  ...
                  >
                    <bdt className="question">Ireland</bdt>
                    <bdt className="statement-end-if-in-editor">
                      <span
                        style={{
                          fontSize: "11.0pt",
                ...
                at <bdt className="question">O'Connell Street</bdt>
                <bdt className="block-component" />
              </span>
            </span>
            , <bdt className="question">Dublin</bdt>
          </span>
        </span>
            ...
            <span style={{ fontSize: 15 }}>
              <span data-custom-class="body_text">
                <span style={{ color: "rgb(89, 89, 89)" }}>
                  <bdt className="block-component" />,{" "}
                  <bdt className="question">L</bdt>
                  <bdt className="statement-end-if-in-editor" />
                  <bdt className="block-component" />{" "}
                  <bdt className="question">D02 X285</bdt>
                  <bdt className="statement-end-if-in-editor" />
                </span>
              </span>
            </span>
    ...
    <div align="center" style={{ textAlign: "left" }}>
      ...
      >
        <bdt className="question">
          An ai support chatbot that easily integrates into your website and
          helps your customers with any question they may have and they can also
      ...
      >
        ...
        >
          ...
          phone at <bdt className="question">0899788700</bdt>, email at{" "}
          <bdt className="question">botassistai@gmail.com</bdt>
          <bdt className="block-component" />,
          <bdt className="statement-end-if-in-editor" /> or by mail to{" "}
          <bdt className="question">O'Connell Street</bdt>
          <bdt className="block-component" />,{" "}
          <bdt className="question">Dublin</bdt>
          <bdt className="block-component" />, <bdt className="question">L</bdt>
          <bdt className="statement-end-if-in-editor" />
          <bdt className="block-component" />{" "}
          <bdt className="question">D02 X285</bdt>
          <bdt className="statement-end-if-in-editor" />
      ...
      >
        ...
        >
          ...
          ), and <bdt className="question">BotAssistAi</bdt>, concerning your
      ...
      >
        ...
        >
          ...
          <bdt className="question">info@botassistai.com</bdt>, as stated in the
    ...
    <div align="center" style={{ textAlign: "left" }}>
      ...
      >
        ...
        >
          ...
          <bdt className="question">botassistai@gmail.com</bdt>. If we ever
    ...
    <div align="center" style={{ textAlign: "left" }}>
      ...
      >
        <span style={{ fontSize: 15 }}>
          ...
          licence
          <bdt className="else-block" /> to: use, copy, reproduce, distribute,
          ...
          works, your Contributions, and to <bdt className="block-component" />
          sublicence the licences
          <bdt className="else-block" /> granted in this section. Our use and
      ...
      >
        <span style={{ fontSize: 15 }}>
          ...
          licence
          <bdt className="else-block" /> includes our use of your name, company
    ...
    <div align="center" style={{ textAlign: "left" }}>
      ...
      >
        ...
        >
          in <bdt className="question">Euros</bdt>.
        </span>
      </div>
    </div>
    <div align="center" style={{ lineHeight: "1.5" }}>
    ...
    <div align="center" style={{ textAlign: "left", lineHeight: "1.5" }}>
      ...
      >
        <span style={{ fontSize: 15 }}>
          <bdt className="block-component" />
          <bdt className="question">
            After their subscription expires, they will be able to see and repay
            by themselves
          </bdt>
          <bdt className="statement-end-if-in-editor" />
        </span>
      ...
      >
        ...
        <span style={{ fontSize: 15 }}>
          ...
          <bdt className="statement-end-if-in-editor" />
          <bdt className="block-component" />
          <bdt className="question">Cannot cancel subscription</bdt>
          <bdt className="statement-end-if-in-editor" /> Your cancellation will
              ...
              >
                ...
                >
                  ...
                  >
                    ...
                    <bdt className="else-block" /> of the foregoing. The use and
            ...
            <bdt data-type="body">
              ...
              >
                ...
                >
                  This <bdt className="block-component" />
                  licence
                  <bdt className="else-block" /> will apply to any form, media,
            ...
            <bdt data-type="body">
              ...
              >
                ...
                >
                  ...
                  <bdt className="block-component" />
                  re-categorise
                  <bdt className="else-block" /> any Contributions to place them
                  in more appropriate locations on the Services; and (3) to
      ...
      >
        ...
        <strong>
          ...
          <span style={{ color: "rgb(0, 58, 250)" }}>
            ...
            >
              <a
                href="https://botassistai.com/privacy-policy"
                target="_blank"
                data-custom-class="link"
              >
                https://botassistai.com/privacy-policy
              </a>
            </bdt>
          </span>
        </strong>
    ...
    >
      ...
      >
        ...
        your country to residence. <bdt className="question">BotAssistAi</bdt>{" "}
        and yourself both agree to submit to the non-exclusive jurisdiction of
        the courts of <bdt className="question">Laois</bdt>, which means that
        you may make a claim to defend your consumer protection rights in
        regards to these Legal Terms in <bdt className="block-component" />
        <bdt className="question">Ireland</bdt>
        <span
          style={{
            fontSize: "11pt",
    ...
    >
      ...
      <bdt className="block-component" />
      <bdt className="question">Berlin</bdt>,{" "}
      <bdt className="block-component" />
      <bdt className="question">Ireland</bdt>
      <bdt className="else-block" />. The language of the proceedings shall be{" "}
      <bdt className="question">English</bdt>. Applicable rules of substantive
      law shall be the law of <bdt className="block-component" />
      <bdt className="question">Ireland</bdt>
      <bdt className="statement-end-if-in-editor" />.
      <bdt className="else-block" />
    </div>
    ...
    >
      ...
      utilise
      <bdt className="else-block" /> class action procedures; and (c) there is
    ...
    >
      ...
      relief. If this provision is found to be illegal or unenforceable, then
    ...
    >
      <strong>
        ...
        >
          <strong>
            <bdt className="block-component" />
            Phone: <bdt className="question">0899788700</bdt>
            <bdt className="statement-end-if-in-editor" />
          </strong>
        </span>
      </strong>
