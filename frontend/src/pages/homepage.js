...
const Homepage = () => {
  ...
  return (
    ...
    />
          ...
          <h1>Tired of Answering the Same <br /> Customer Questions Every Day?</h1>
          <p>
          Let our AI chatbot handle them — 24/7, instantly, on your website.
          </p>
          <Link to={"/sign-up"}>
          <button className="cta">Try It Free – No Credit Card</button>
          </Link>
        </section>
